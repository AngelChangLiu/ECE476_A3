...
def run_scenes(n_runs):
    ...
    for scene in scene_names:
        ...
        if scene in score_scene_names:
            ...
            if(args and args.super):
                ref_binary = "./render_ref_super"
            else:
                ref_binary = "./render_ref"
...
parser.add_argument("--super", action="store_true", help="Test against the super reference", default=False)
args = parser.parse_args()

correct, stu_times, ref_times = run_scenes(test_times)
